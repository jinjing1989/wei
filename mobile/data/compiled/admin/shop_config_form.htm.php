...
?>
          <label for="value_<?php echo $this->_var['var']['id']; ?>_<?php echo $this->_var['k']; ?>"><input type="radio" name="value[<?php echo $this->_var['var']['id']; ?>]" id="value_<?php echo $this->_var['var']['id']; ?>_<?php echo $this->_var['k']; ?>" value="<?php echo $this->_var['opt']; ?>"
            ...
            <?php endif; ?>
          /><?php echo $this->_var['var']['display_options']; ?></label>
          ...
          <select name="value[<?php echo $this->_var['var']['id']; ?>]" id="value_<?php echo $this->_var['var']['id']; ?>_<?php echo $this->_var['key']; ?>">
            <?php echo $this->html_options(array('options'=>$this->_var['lang']['cfg_range'],'selected'=>$this->_var['var']['value'])); ?>
          </select>
...
?>
            ...
            <table>
              ...
              <tr>
                <td><input name="invoice_type[]" type="text" value="<?php echo $this->_var['cfg']['invoice_type']['type']; ?>" /></td>
                <td><input name="invoice_rate[]" type="text" value="<?php echo $this->_var['cfg']['invoice_type']['rate']; ?>" /></td>
              </tr>
              <tr>
                <td><input name="invoice_type[]" type="text" value="<?php echo $this->_var['cfg']['invoice_type']['type']; ?>" /></td>
                <td><input name="invoice_rate[]" type="text" value="<?php echo $this->_var['cfg']['invoice_type']['rate']; ?>" /></td>
